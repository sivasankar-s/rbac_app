...
const RoleRecord = ({name, permissions, id, handleEditRole, handleDeleteRole}) => {
  ...
  return (
    ...
    <div className='bg-slate-200 text-gray-800 rounded-md grid grid-cols-3 hover:shadow-sm hover:bg-slate-300 transition-all'>
        ...
        <div className='col-span-1 lg:col-span-1 p-2 flex justify-center'>
            ...
            <button onClick={() => handleDeleteRole(id)} className='text-xl text-gray-800 p-2 md:hover:text-red-500 md:hover:bg-white transition-all rounded-full'><MdDelete /></button>
        </div>    
